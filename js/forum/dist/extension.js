                ...
                babelHelpers.createClass(QuillEditor, [{
                    ...
                    value: function view() {
                        ...
                        return m(
                            ...
                            m('div', { className: classNames, config: this.configEditor.bind(this) }),
                            m(
                                'ul',
                    ...
                    key: 'configEditor',
                    value: function configEditor(element, isInitialized) {
                        ...
                        function saveToServer(file) {
                            ...
                            xhr.onload = function () {
                                if (xhr.status === 201) {
                                    ...
                                    var xxkk = url[0].replace('[upl-image-preview url=', '').replace(']', '');
